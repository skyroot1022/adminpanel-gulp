    ...
    tasks.push(
        new Promise(function(resolve, reject) {
            gulp.src(path.src.structure) // get structure templates
                ...
                .pipe(wrap({src: path.src.versions + arrayHtml})) // insert all pages to layout
                ...
                .pipe(gulp.dest(path.build.versions + arrayHtml.replace('.html', ''))) // copy generated pages to build folder
                .on('end', resolve)
        })
    )
